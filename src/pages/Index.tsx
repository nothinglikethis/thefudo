...
const features = [
  ...
  { icon: 'bis', title: 'BIS Certified', desc: 'Meets Bureau of Indian Standards IS:10500.' },
    ...
    <div ref={revealRef}>
      ...
      <section className="relative min-h-screen bg-fudo-black flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center min-h-screen py-28 sm:py-32">
            {/* Left */}
            <div className="order-2 lg:order-1">
              <p className="text-label text-primary flex items-center gap-3 mb-6 sm:mb-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                <span className="w-8 h-px bg-primary inline-block" />
                PURE DRINKING WATER • SURAT, GUJARAT
              </p>
              <h1 className="text-display-xl text-primary-foreground mb-4 sm:mb-6 animate-fade-in-up" style={{ animationDelay: '0.25s' }}>
                Hydration,{' '}
                <span className="text-primary italic">Refined.</span>
              </h1>
              <p className="font-secondary text-base sm:text-lg text-primary-foreground/65 max-w-lg mb-4 sm:mb-6 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Crafted with precision in Surat, Gujarat — Fudo delivers water that meets 
                the highest standards of purity, taste, and trust.
              </p>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-pill bg-primary/10 border border-primary/30 mb-6 sm:mb-8 animate-fade-in-up" style={{ animationDelay: '0.55s' }}>
                <span className="font-secondary text-sm text-primary font-medium">Have you had your FUDO yet?</span>
              </div>
              <div className="flex flex-wrap gap-3 sm:gap-4 mb-8 sm:mb-10 animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
                <Link
                  to="#products"
                  className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-primary text-primary-foreground font-secondary text-sm font-medium tracking-widest uppercase rounded-pill transition-all duration-300 hover:bg-brand-orange-hover hover:-translate-y-0.5 hover:shadow-lg"
                >
                  Explore Products
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 border border-primary-foreground/60 text-primary-foreground font-secondary text-sm font-medium tracking-widest uppercase rounded-pill transition-all duration-300 hover:bg-primary-foreground hover:text-fudo-black"
                >
                  Contact Us
                </Link>
              </div>
              <div className="flex flex-wrap items-center gap-3 text-primary-foreground/45 font-secondary text-xs tracking-wider animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
                <img src={bisLogo} alt="BIS Certified" className="h-7 w-auto object-contain opacity-80" />
            ...
            <div className="order-1 lg:order-2 flex items-center justify-center relative">
              {/* Rotating rings */}
              <div className="absolute w-[280px] sm:w-[380px] h-[280px] sm:h-[380px] rounded-full border border-primary/20 animate-rotate-slow hidden sm:block" />
              <div className="absolute w-[360px] sm:w-[480px] h-[360px] sm:h-[480px] rounded-full border border-dashed border-primary/10 animate-rotate-slow-reverse hidden sm:block" />
              {/* Glow */}
              <div className="absolute w-48 sm:w-64 h-48 sm:h-64 rounded-full bg-primary/20 blur-[80px] animate-pulse-glow" />
              <img
                src={bottleHero}
                alt="Fudo 1 Litre Premium Diamond-Cut Water Bottle"
                className="relative z-10 h-[35vh] sm:h-[45vh] lg:h-[70vh] object-contain animate-float-bottle drop-shadow-2xl"
                width={800}
                height={1200}
              />
            </div>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 sm:px-5 lg:px-10 text-center">
          <p className="reveal-element text-label text-primary mb-4 sm:mb-6 tracking-widest">OUR PROMISE</p>
          <h2 className="reveal-element text-display-md text-foreground max-w-3xl mx-auto mb-6 sm:mb-8">
            Purity. Precision. Perfection.
          </h2>
          <p className="reveal-element text-pull-quote text-primary max-w-2xl mx-auto mb-10 sm:mb-16">
      ...
      {/* PRODUCT COLLECTIONS */}
      <section id="products" className="py-16 sm:py-24 lg:py-32 bg-fudo-off-white">
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          ...
          {/* Tabs */}
          <div className="reveal-element flex flex-wrap justify-center gap-2 mb-8 sm:mb-12">
            {productTabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`px-4 sm:px-6 py-2.5 sm:py-3 font-secondary text-xs sm:text-sm font-medium tracking-wider uppercase rounded-pill transition-all duration-300 ${
                  activeTab === tab.id
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            <div className="reveal-left">
              <h3 className="font-primary text-2xl sm:text-4xl font-semibold text-foreground mb-4">{activeProduct.title}</h3>
              <p className="font-secondary text-base sm:text-lg text-muted-foreground leading-relaxed mb-6 sm:mb-8">{activeProduct.subtitle}</p>
            ...
            <div className="reveal-right flex justify-center">
              <img
                ...
                className="h-[280px] sm:h-[400px] object-contain drop-shadow-xl"
                loading="lazy"
                width={400}
                height={600}
              />
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-primary-foreground/5">
            {features.map((f, i) => (
              <div
                key={f.title}
                className="reveal-element bg-fudo-dark-gray p-6 sm:p-8 transition-all duration-300 hover:bg-[#2A2A2A] hover:border-l-[3px] hover:border-l-primary group"
                style={{ transitionDelay: `${i * 50}ms` }}
              >
                {f.icon === 'bis'
                  ? <img src={bisLogo} alt="BIS Certified" className="h-10 w-auto object-contain mb-4 brightness-0 invert opacity-80" />
                  : <span className="text-3xl mb-4 block">{f.icon}</span>
                }
                <h4 className="font-secondary text-base sm:text-lg font-semibold text-primary-foreground mb-2">{f.title}</h4>
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-start">
            <div className="reveal-left">
              ...
              <h2 className="font-primary text-2xl sm:text-4xl font-semibold text-foreground mb-6">Purity Defined</h2>
              <p className="font-secondary text-base sm:text-lg text-muted-foreground leading-relaxed mb-4">
              ...
              <p className="font-secondary text-sm sm:text-base text-muted-foreground leading-relaxed mb-6">
            ...
            <div className="reveal-right overflow-x-auto">
              <div className="bg-background rounded-lg shadow-[var(--shadow-card)] overflow-hidden min-w-[280px]">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="text-left p-3 sm:p-4 font-secondary text-xs font-semibold tracking-widest uppercase text-muted-foreground">Parameter</th>
                      <th className="text-right p-3 sm:p-4 font-secondary text-xs font-semibold tracking-widest uppercase text-primary">Fudo</th>
                      <th className="text-right p-3 sm:p-4 font-secondary text-xs font-semibold tracking-widest uppercase text-muted-foreground">Safe Limit</th>
                    </tr>
                  </thead>
                  <tbody>
                    {qualityData.map((row) => (
                      <tr key={row.param} className="border-b border-border/50 hover:bg-muted/50 transition-colors">
                        <td className="p-3 sm:p-4 font-secondary text-sm text-foreground">{row.param}</td>
                        <td className="p-3 sm:p-4 text-right font-secondary text-sm font-semibold text-primary">{row.fudo} {row.unit}</td>
                        <td className="p-3 sm:p-4 text-right font-secondary text-sm text-muted-foreground">{row.limit} {row.unit}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          ...
          <div className="reveal-element flex gap-4 sm:gap-6 overflow-x-auto pb-4 snap-x snap-mandatory hide-scrollbar">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="min-w-[260px] sm:min-w-[300px] max-w-[420px] shrink-0 snap-start bg-background border border-border rounded-lg p-6 sm:p-8 hover:shadow-[var(--shadow-card-hover)] transition-shadow duration-300"
              >
                <div className="h-[3px] w-12 bg-primary rounded-full mb-4 sm:mb-6" />
                ...
                <p className="font-accent text-lg sm:text-xl italic text-foreground leading-relaxed mb-4 sm:mb-6">"{t.quote}"</p>
                <div>
      ...
      <section className="py-20 sm:py-32 lg:py-40 bg-fudo-charcoal relative">
        <div className="container mx-auto px-4 sm:px-5 lg:px-10 text-center relative z-10">
          <p className="reveal-element text-label text-primary mb-4 sm:mb-6 tracking-widest">OUR COMMITMENT</p>
          <h2 className="reveal-element text-display-md text-primary-foreground mb-4 sm:mb-6">For a Refreshing Future</h2>
          <p className="reveal-element font-secondary text-base sm:text-lg text-primary-foreground/65 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed">
            At Fudo, sustainability isn't an afterthought — it's woven into every bottle, every delivery, every decision.
          </p>
          <Link
            to="/sustainability"
            className="reveal-element inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 border border-primary-foreground/60 text-primary-foreground font-secondary text-sm font-medium tracking-widest uppercase rounded-pill transition-all duration-300 hover:bg-primary-foreground hover:text-fudo-black"
          >
            Learn More
          </Link>
      ...
      <section className="py-16 sm:py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10 text-center relative z-10">
          <h2 className="font-primary text-2xl sm:text-4xl lg:text-5xl font-bold text-primary-foreground mb-4">
            Ready to make the switch to Fudo?
          </h2>
          <p className="font-secondary text-base sm:text-lg text-primary-foreground/80 mb-6 sm:mb-8 max-w-xl mx-auto">
            Join hundreds of businesses and families across Surat who trust Fudo for their daily hydration.
          </p>
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 border-2 border-primary-foreground text-primary-foreground font-secondary text-sm font-medium tracking-widest uppercase rounded-pill transition-all duration-300 hover:bg-primary-foreground hover:text-primary"
            >
              Get In Touch
            </Link>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-primary-foreground text-primary font-secondary text-sm font-medium tracking-widest uppercase rounded-pill transition-all duration-300 hover:bg-primary-foreground/90"
            >
              WhatsApp Us
            </a>
          </div>
