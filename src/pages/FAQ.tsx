...
const faqs = [
  ...
  { q: 'How can I order Fudo water?', a: 'You can order through our website contact form, call us at +91 70165 47502, or reach us directly on WhatsApp. For bulk orders, our team will work with you to create a customized supply plan.' },
  ...
  { q: 'How can I contact Fudo?', a: 'You can reach us at +91 70165 47502 (phone & WhatsApp), email us at foodobevarages@gmail.com, or visit our facility on Canal Road, Near Bullet Train Track, Surat – 395010. Our hours are Monday to Saturday, 9 AM to 6 PM.' },
];
  ...
  return (
    <div ref={revealRef}>
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-5 lg:px-10 max-w-3xl">
