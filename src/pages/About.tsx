...
const About = () => {
  ...
  return (
    <div ref={revealRef}>
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            <div className="reveal-left">
              ...
              <h2 className="font-primary text-2xl sm:text-4xl font-semibold text-foreground mb-6">
              ...
              <p className="font-secondary text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            <div className="reveal-right flex justify-center">
              <img src={bottleHero} alt="Fudo Premium Water Bottle" className="h-[280px] sm:h-[400px] object-contain drop-shadow-xl" loading="lazy" width={400} height={600} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-fudo-off-white">
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={item.title} className="reveal-element text-center p-8 sm:p-10 bg-background rounded-lg shadow-[var(--shadow-card)]">
                <span className="text-4xl mb-4 block">{item.icon}</span>
                <h3 className="font-primary text-xl sm:text-2xl font-semibold text-foreground mb-3">{item.title}</h3>
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {filtrationSteps.map((step) => (
              <div key={step.step} className="reveal-element p-6 sm:p-8 border border-border rounded-lg hover:border-primary/30 hover:shadow-[var(--shadow-card)] transition-all duration-300">
                <span className="font-primary text-3xl font-bold text-primary/30 mb-3 block">{step.step}</span>
                <h4 className="font-secondary text-base sm:text-lg font-semibold text-foreground mb-2">{step.title}</h4>
        ...
        <div className="container mx-auto px-4 sm:px-5 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            ...
            <div className="reveal-right overflow-x-auto">
              <div className="bg-fudo-off-white rounded-lg shadow-[var(--shadow-card)] overflow-hidden min-w-[280px]">
